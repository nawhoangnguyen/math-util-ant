...
//Phàm cái gì là đồ dùng chung, thường đc thiết ế là static
public class MathUtil {
    ...
    //Lưu ý/quy ước:
    //- Không tính giai thừa số ấm!!!
    //0! = 1! =1
    //Vì gia thừa tăng cực nhanh, nên 21! đã vượt 18 số 0
    //tràn kiểu long
